    ...
    <>
      <div className='flex flex-col min-h-screen items-center justify-center align-center'>
        ...
        <div className='flex ARRIBA'>
          ...
          <Card imagen={"Pieces/WArfil.png"} titulo="Arfil" descripcion={"Se mueve en línea diagonal por todo el tablero, sin límite de casillas. Siempre se mantiene en el color de casilla en el que empezó."} />
        </div>
        {/* Abajo */}
        <div className='flex ABAJO'>
          ...
          <Card imagen={"Pieces/WReina.png"}   titulo="Reina" descripcion={"Es la pieza más poderosa. Combina los movimientos de la torre y el alfil, moviéndose en línea recta o diagonal tantas casillas como quiera."} />
        </div>
      </div>
    </>
  )
